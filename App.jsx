...
const EVENTS = [
  ...
  },
  {
    ...
    fights: [
      { id: 1, section: "MAIN EVENT", fighter1: "Max Holloway", fighter2: "Charles Oliveira", record1: "27-8", record2: "36-11", weightClass: "Lightweight", lbs: 155, note: "Oliveira wins BMF — dominant grappling UD (50-45 x3)", belt: true, bio1: "Current BMF champion & former featherweight king", bio2: "Former lightweight champion, most finishes in UFC history" },
      { id: 2, section: "CO-MAIN EVENT", fighter1: "Caio Borralho", fighter2: "Reinier de Ridder", record1: "17-2", record2: "17-2", weightClass: "Middleweight", lbs: 185, note: "Borralho UD (30-27 x3) — calls out Du Plessis", bio1: "Brazilian contender on a 7-fight win streak before first loss", bio2: "Dutch submission specialist, former ONE champion" },
      { id: 3, section: "MAIN CARD", fighter1: "Rob Font", fighter2: "Raul Rosas Jr.", record1: "21-8", record2: "10-1", weightClass: "Bantamweight", lbs: 135, note: "Rosas Jr. UD (30-27 x3) — grappling masterclass", bio1: "Top-10 bantamweight veteran", bio2: "20-year-old phenom on 4-fight win streak" },
      { id: 4, section: "MAIN CARD", fighter1: "Drew Dober", fighter2: "Michael Johnson", record1: "28-15", record2: "24-19", weightClass: "Lightweight", lbs: 155, note: "Dober KO R2 (1:53) — massive left hand", bio1: "Banger back on track", bio2: "The Menace on 3-fight win streak" },
      { id: 5, section: "MAIN CARD", fighter1: "Gregory Rodrigues", fighter2: "Brunno Ferreira", record1: "16-4", record2: "11-1", weightClass: "Middleweight", lbs: 185, note: "Rodrigues KO R1 (1:47) — straight right, revenge", bio1: "Electric finisher, 2 straight wins", bio2: "Unbeaten in UFC" },
      { id: 6, section: "PRELIMS", fighter1: "Cody Garbrandt", fighter2: "Long Xiao", record1: "13-6", record2: "16-3", weightClass: "Bantamweight", lbs: 135, note: "Garbrandt UD — Xiao docked 2pts for low blows", bio1: "Former UFC bantamweight champion", bio2: "Chinese prospect with serious power" },
      { id: 7, section: "PRELIMS", fighter1: "Donte Johnson", fighter2: "Cody Brundage", record1: "7-0", record2: "12-5", weightClass: "Middleweight", lbs: 185, note: "Donte Johnson split dec (29-28, 28-29, 29-28)", bio1: "UFC debut, undefeated", bio2: "UFC vet on short notice" },
      { id: 8, section: "PRELIMS", fighter1: "Alberto Montes", fighter2: "Ricky Turcios", record1: "10-1", record2: "12-2", weightClass: "Featherweight", lbs: 145, note: "Montes sub R2 (0:40) — anaconda choke", bio1: "Rising contender", bio2: "High-octane action fighter" },
      { id: 9, section: "PRELIMS", fighter1: "Cody Durden", fighter2: "Nyamjargal Tumendemberel", record1: "16-5-1", record2: "16-3", weightClass: "Flyweight", lbs: 125, note: "Tumendemberel UD (30-27, 30-27, 29-28)", bio1: "Durable veteran", bio2: "Mongolian striker" },
      { id: 10, section: "EARLY PRELIMS", fighter1: "Sumudaerji", fighter2: "Jesus Aguilar", record1: "17-5", record2: "9-4", weightClass: "Flyweight", lbs: 125, note: "Sumudaerji UD (30-27 x3)", bio1: "Chinese fan favorite 'Flash'", bio2: "Mexican slugger" },
      { id: 11, section: "EARLY PRELIMS", fighter1: "Rafael Tobias", fighter2: "Diyar Nurgozhay", record1: "8-1", record2: "9-3", weightClass: "Light Heavyweight", lbs: 205, note: "Nurgozhay UD (30-27, 29-28, 29-28)", bio1: "Brazilian prospect", bio2: "Kazakhstani contender" },
      { id: 13, section: "EARLY PRELIMS", fighter1: "Luke Fernandez", fighter2: "Rodolfo Bellato", record1: "9-1", record2: "10-3", weightClass: "Light Heavyweight", lbs: 205, note: "Bellato TKO R1 (2:42)", bio1: "Australian prospect", bio2: "Brazilian contender" },
    ],
  },
  {
