...
const EVENTS = [
  {
    id: "ufcevloevvsmurphy", name: "UFC London", subtitle: "Evloev vs. Murphy",
    date: "March 21, 2026", venue: "The O2 Arena, London England",
    broadcast: "Paramount+", status: "upcoming",
    fights: [
      { id: 1, section: "MAIN EVENT", fighter1: "Movsar Evloev", fighter2: "Lerone Murphy", record1: "19-0", record2: "17-0-1", weightClass: "Featherweight", lbs: 145, note: "Title eliminator — two unbeatens collide, record 36-0-1 combined", bio1: "Russian grappling machine, unbeaten in 19 fights", bio2: "The Bullet, Manchester's unbeaten featherweight, UFC record holder" },
      { id: 2, section: "CO-MAIN EVENT", fighter1: "Luke Riley", fighter2: "Michael Aswell Jr.", record1: "12-0", record2: "11-3", weightClass: "Featherweight", lbs: 145, note: "Liverpool's unbeaten rising star vs. Houston finisher", bio1: "Unbeaten Liverpool featherweight, trains with Paddy Pimblett", bio2: "American finisher from Houston, TX" },
      { id: 3, section: "MAIN CARD", fighter1: "Michael Page", fighter2: "Sam Patterson", record1: "24-3", record2: "14-2-1", weightClass: "Welterweight", lbs: 170, note: "MVP returns to welterweight for the London crowd", bio1: "Venom, former Bellator star, London showman", bio2: "Red-hot English welterweight from Watford" },
      { id: 4, section: "MAIN CARD", fighter1: "Iwo Baraniewski", fighter2: "Austen Lane", record1: "7-0", record2: "13-7-1", weightClass: "Light Heavyweight", lbs: 205, note: "Unbeaten Polish prospect vs. former NFL player", bio1: "Unbeaten Warsaw light heavyweight, UFC debut sensation", bio2: "Former NFL player turned UFC fighter, Jacksonville FL" },
      { id: 5, section: "MAIN CARD", fighter1: "Roman Dolidze", fighter2: "Christian Leroy Duncan", record1: "15-4", record2: "13-2", weightClass: "Middleweight", lbs: 185, note: "Top-15 MW contender defends ranking vs. Gloucester's Duncan", bio1: "Georgian striker, #11 UFC middleweight", bio2: "Christian Leroy Duncan, Gloucester England" },
      { id: 6, section: "MAIN CARD", fighter1: "Kurtis Campbell", fighter2: "Danny Silva", record1: "8-0", record2: "11-4", weightClass: "Featherweight", lbs: 145, note: "Unbeaten Liverpool featherweight makes UFC debut on home soil", bio1: "Unbeaten DWCS graduate from Liverpool, UFC debut", bio2: "Portuguese featherweight" },
      { id: 7, section: "PRELIMS", fighter1: "Mason Jones", fighter2: "Axel Sola", record1: "13-3", record2: "11-3", weightClass: "Lightweight", lbs: 155, note: "Welsh lightweight looking to get back on track", bio1: "Welsh lightweight, action fighter", bio2: "French lightweight contender" },
      { id: 8, section: "PRELIMS", fighter1: "Nathaniel Wood", fighter2: "Losene Keita", record1: "18-6", record2: "11-4", weightClass: "Featherweight", lbs: 145, note: "The Prospect looks to rebound in front of home fans", bio1: "The Prospect, English featherweight veteran", bio2: "French-Guinean featherweight" },
      { id: 9, section: "PRELIMS", fighter1: "Mario Pinto", fighter2: "Felipe Franco", record1: "9-1", record2: "6-1", weightClass: "Heavyweight", lbs: 265, note: "Unbeaten Portuguese HW vs. Brazilian newcomer", bio1: "Unbeaten Portuguese heavyweight prospect", bio2: "Brazilian heavyweight newcomer" },
      { id: 10, section: "PRELIMS", fighter1: "Mantas Kondratavicius", fighter2: "Antonio Trocoli", record1: "13-5", record2: "14-4", weightClass: "Middleweight", lbs: 185, note: "Lithuanian vs. Brazilian middleweight clash", bio1: "Lithuanian middleweight", bio2: "Brazilian middleweight" },
      { id: 11, section: "PRELIMS", fighter1: "Louie Sutherland", fighter2: "Brando Pericic", record1: "13-5", record2: "8-3", weightClass: "Heavyweight", lbs: 265, note: "Scottish heavyweight vs. Croatian prospect", bio1: "Scottish heavyweight brawler", bio2: "Croatian heavyweight prospect" },
      { id: 12, section: "PRELIMS", fighter1: "Shem Rock", fighter2: "Abdul-Kareem Al-Selwady", record1: "16-6", record2: "8-2", weightClass: "Lightweight", lbs: 155, note: "Lightweight prelim", bio1: "Northern Irish lightweight veteran", bio2: "British-Yemeni lightweight" },
      { id: 13, section: "PRELIMS", fighter1: "Shanelle Dyer", fighter2: "Ravena Oliveira", record1: "6-1", record2: "7-3-1", weightClass: "Women's Strawweight", lbs: 115, note: "London's Dyer fights at home vs. Brazilian finisher", bio1: "London strawweight fighting on home turf", bio2: "Brazilian strawweight with 100% finish rate" },
    ]
  },
  {
  ...
  },
  {
    ...
    broadcast: "Paramount+", status: "past",
    fights: [
      { id: 1, section: "MAIN EVENT", fighter1: "Josh Emmett", fighter2: "Kevin Vallejos", record1: "19-7", record2: "18-1", weightClass: "Featherweight", lbs: 145, note: "Vallejos KO R1 (3:33) — stunning upset, El Chino arrives", bio1: "Hard-hitting featherweight veteran, USA", bio2: "El Chino, Argentine phenom — sensational first-round KO" },
      { id: 2, section: "CO-MAIN EVENT", fighter1: "Amanda Lemos", fighter2: "Gillian Robertson", record1: "15-6-1", record2: "17-8", weightClass: "Strawweight", lbs: 115, note: "Robertson UD — grappling clinic over three rounds", bio1: "Brazilian striker, #7 UFC strawweight", bio2: "The Savage, Canadian grappler earns big win" },
      { id: 3, section: "MAIN CARD", fighter1: "Oumar Sy", fighter2: "Ion Cutelaba", record1: "12-2", record2: "20-11-1", weightClass: "Light Heavyweight", lbs: 205, note: "Cutelaba submission R1 (4:24) — The Hulk stops the Frenchman", bio1: "French light heavyweight", bio2: "The Hulk, Moldovan brawler gets the finish" },
      { id: 4, section: "MAIN CARD", fighter1: "Andre Fili", fighter2: "Jose Delgado", record1: "25-13", record2: "11-2", weightClass: "Featherweight", lbs: 145, note: "Delgado split decision — prospect edges veteran in close one", bio1: "Veteran featherweight, USA", bio2: "Touchy, American featherweight prospect gets the nod" },
      { id: 5, section: "MAIN CARD", fighter1: "Marwan Rahiki", fighter2: "Harry Hardwick", record1: "8-0", record2: "13-5-1", weightClass: "Featherweight", lbs: 145, note: "Rahiki TKO R2 — unbeaten Australian still rolling", bio1: "Unbeaten Australian prospect stays perfect", bio2: "Houdini, British veteran" },
      { id: 6, section: "MAIN CARD", fighter1: "Vitor Petrino", fighter2: "Steven Asplund", record1: "14-2", record2: "7-2", weightClass: "Heavyweight", lbs: 265, note: "Petrino UD — Brazilian controls three rounds", bio1: "Brazilian heavyweight contender", bio2: "Concrete, American heavyweight" },
      { id: 7, section: "PRELIMS", fighter1: "Bruno Silva", fighter2: "Charles Johnson", record1: "15-8-2", record2: "19-8", weightClass: "Flyweight", lbs: 125, note: "Johnson split decision — tough call in flyweight fight", bio1: "Brazilian flyweight", bio2: "InnerG, American flyweight gets the split" },
      { id: 8, section: "PRELIMS", fighter1: "Brad Tavares", fighter2: "Eryk Anders", record1: "21-12", record2: "18-9", weightClass: "Middleweight", lbs: 185, note: "Anders UD — Ya Boi outworks Tavares over three rounds", bio1: "Hawaiian middleweight veteran", bio2: "Ya Boi earns unanimous decision" },
      { id: 9, section: "PRELIMS", fighter1: "Chris Curtis", fighter2: "Myktybek Orolbai", record1: "32-13", record2: "16-2-1", weightClass: "Welterweight", lbs: 170, note: "Orolbai UD — Kyrgyz fighter upsets The Action Man", bio1: "The Action Man, American welterweight", bio2: "Kyrgyzstan welterweight wins big" },
      { id: 10, section: "PRELIMS", fighter1: "Bolaji Oki", fighter2: "Manoel Sousa", record1: "10-4", record2: "14-1", weightClass: "Lightweight", lbs: 155, note: "Sousa TKO R3 (4:12) — Manumito finishes in the third", bio1: "The Zulu Warrior, Belgian lightweight", bio2: "Manumito, Brazilian lightweight stops Oki late" },
      { id: 11, section: "PRELIMS", fighter1: "Luan Lacerda", fighter2: "Hecher Sosa", record1: "13-4", record2: "15-1", weightClass: "Bantamweight", lbs: 135, note: "Sosa UD — Spanish bantamweight upsets Brazilian", bio1: "Brazilian bantamweight", bio2: "Guanche Warrior earns upset decision" },
      { id: 12, section: "PRELIMS", fighter1: "Bia Mesquita", fighter2: "Montse Rendon", record1: "7-0", record2: "7-2", weightClass: "Women's Bantamweight", lbs: 135, note: "Mesquita submission R1 (2:07) — stays unbeaten with quick finish", bio1: "Unbeaten Brazilian, dominant submission win", bio2: "Monster, Mexican fighter" },
      { id: 13, section: "PRELIMS", fighter1: "Elijah Smith", fighter2: "Su Young You", record1: "10-1", record2: "16-4", weightClass: "Bantamweight", lbs: 135, note: "Smith submission R2 (1:04) — quick finish for the American", bio1: "American bantamweight prospect stays hot", bio2: "Yoo-Jitsu, South Korean bantamweight" },
      { id: 14, section: "PRELIMS", fighter1: "Piera Rodriguez", fighter2: "Sam Hughes", record1: "12-2", record2: "11-7", weightClass: "Strawweight", lbs: 115, note: "Rodriguez UD — La Fiera controls all three rounds", bio1: "La Fiera, Venezuelan strawweight gets the win", bio2: "Sampage, American strawweight" },
    ]
  },
  {
    ...
    fights: [
      { id: 1, section: "MAIN EVENT", fighter1: "Max Holloway", fighter2: "Charles Oliveira", record1: "27-9", record2: "37-11", weightClass: "Lightweight", lbs: 155, note: "Oliveira wins BMF — dominant grappling UD (50-45 x3)", belt: true, bio1: "Blessed, former UFC featherweight champion, Hawaiian", bio2: "Do Bronx, former UFC lightweight champion, Brazil" },
      { id: 2, section: "CO-MAIN EVENT", fighter1: "Caio Borralho", fighter2: "Reinier de Ridder", record1: "18-2", record2: "21-4", weightClass: "Middleweight", lbs: 185, note: "Borralho UD (30-27 x3) — calls out Du Plessis", bio1: "Brazilian middleweight contender, The Natural", bio2: "The Dutch Knight, former two-division ONE champion" },
      { id: 3, section: "MAIN CARD", fighter1: "Rob Font", fighter2: "Raul Rosas Jr.", record1: "22-10", record2: "12-1", weightClass: "Bantamweight", lbs: 135, note: "Rosas Jr. UD (30-27 x3) — 16 takedowns, grappling dominant", bio1: "Veteran bantamweight from Massachusetts", bio2: "El Niño Problema, 21-year-old phenom from New Mexico" },
      { id: 4, section: "MAIN CARD", fighter1: "Drew Dober", fighter2: "Michael Johnson", record1: "29-15", record2: "24-20", weightClass: "Lightweight", lbs: 155, note: "Dober KO R2 (1:53) — massive left hand", bio1: "The Highlight Machine, UFC LW KO record holder, Nebraska", bio2: "The Menace, veteran lightweight, St. Louis MO" },
      { id: 5, section: "MAIN CARD", fighter1: "Gregory Rodrigues", fighter2: "Brunno Ferreira", record1: "19-6", record2: "15-3", weightClass: "Middleweight", lbs: 185, note: "Rodrigues KO R1 (1:47) — straight right, revenge", bio1: "RoboCop, Brazilian finisher", bio2: "The Hulk, Brazilian middleweight" },
      { id: 6, section: "PRELIMS", fighter1: "Cody Garbrandt", fighter2: "Long Xiao", record1: "15-7", record2: "27-11", weightClass: "Bantamweight", lbs: 135, note: "Garbrandt UD — Xiao docked 2pts for low blows", bio1: "No Love, former UFC bantamweight champion, Ohio", bio2: "Chinese bantamweight, Road to UFC finalist" },
      { id: 7, section: "PRELIMS", fighter1: "Donte Johnson", fighter2: "Cody Brundage", record1: "8-0", record2: "12-8-1", weightClass: "Middleweight", lbs: 185, note: "Donte Johnson split dec (29-28, 28-29, 29-28)", bio1: "Undefeated American middleweight", bio2: "UFC veteran middleweight" },
      { id: 8, section: "PRELIMS", fighter1: "Alberto Montes", fighter2: "Ricky Turcios", record1: "12-1", record2: "13-6", weightClass: "Featherweight", lbs: 145, note: "Montes sub R2 (0:40) — anaconda choke", bio1: "Venezuelan featherweight contender", bio2: "Pretty Ricky, Houston TX featherweight" },
      { id: 9, section: "PRELIMS", fighter1: "Cody Durden", fighter2: "Nyamjargal Tumendemberel", record1: "17-10-1", record2: "10-1", weightClass: "Flyweight", lbs: 125, note: "Tumendemberel UD (30-27, 30-27, 29-28)", bio1: "Durable flyweight veteran, Georgia", bio2: "Mongolian flyweight" },
      { id: 10, section: "EARLY PRELIMS", fighter1: "Sumudaerji", fighter2: "Jesus Aguilar", record1: "19-7", record2: "12-4", weightClass: "Flyweight", lbs: 125, note: "Sumudaerji UD (30-27 x3)", bio1: "Flash, Chinese flyweight fan favourite", bio2: "Mexican flyweight" },
      { id: 11, section: "EARLY PRELIMS", fighter1: "Rafael Tobias", fighter2: "Diyar Nurgozhay", record1: "14-2", record2: "11-2", weightClass: "Light Heavyweight", lbs: 205, note: "Nurgozhay UD (30-27, 29-28, 29-28)", bio1: "Bipolar, Brazilian LHW, Chute Boxe Monstro", bio2: "Former Eagle FC LHW champion, Kazakhstan" },
      { id: 13, section: "EARLY PRELIMS", fighter1: "Luke Fernandez", fighter2: "Rodolfo Bellato", record1: "6-1", record2: "13-3-1", weightClass: "Light Heavyweight", lbs: 205, note: "Bellato TKO R1 (2:42)", bio1: "New Jersey prospect, former CFFC LHW champion", bio2: "Trator, Brazilian light heavyweight" },
    ],
  },
  {
